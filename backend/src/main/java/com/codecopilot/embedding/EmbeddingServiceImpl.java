...
/**
 * Uses Spring AI's embedding model (configured against the Grok/xAI
 * OpenAI-compatible endpoint). Falls back to a deterministic hash vector when
 * no API key is configured so the application stays runnable offline.
 */
@Service
public class EmbeddingServiceImpl implements EmbeddingService {
    ...
    public EmbeddingServiceImpl(ObjectProvider<EmbeddingModel> embeddingModels,
